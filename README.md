...
## Verwaltung / invoicing

The German § 14 UStG invoice and bookkeeping system that used to live at `/admin`
now has its own private repository and is deployed at
[admin.silicortex.de](https://admin.silicortex.de). `/admin` and `/admin/*` on this
site redirect there permanently.

It moved because this repository is public and the system is growing to hold expense
and Beleg logic; because a marketing deploy should not redeploy a bookkeeping
system; and because § 147 AO requires ten years of retention, which has to outlive
this site's redesigns.
